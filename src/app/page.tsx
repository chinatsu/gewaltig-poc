      ...
      <div className="w-full md:max-w-3xl flex flex-col gap-8">
        ...
        <section className="flex flex-col gap-6">
          ...
          <p>
            ...
            The longer you play the game the faster the pieces will fall.</p>
        </section>
        <section className="flex flex-col gap-6">
          <h2 className="text-xl">Screen Layout</h2>
          <Image src="/images/manual.jpg" alt="Screen layout" height={455} width={768} />
        </section>
        <section className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div>
              ...
              <p>
                ...
                Now 3 lines is not very threatening, is it?
                That&apos;s why there is another way to send more lines to an opponent, a lot more.
                Think combos.
              </p>
            </div>
            <div className="flex flex-col gap-2">
              ...
              <p>
                Combos are what Cultris II is all about. Every time you delete a line you will see that you get some time on your combo-timer.
            ...
            <div className="flex flex-col gap-2">
              ...
              <p>You probably noticed during a game or just by reading this manual that the amount of garbage you receive can be a lot more than just the 18 lines you have on your playfield, especially in a 1 on 1 game.
