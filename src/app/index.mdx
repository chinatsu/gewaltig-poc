...
<table>
    <tbody>
        <tr>
            <th>Delay</th>
            <td>The higher the delay the longer it takes (the longer you have to keep pressing key) before the repeater starts. It has nothing to do with the speed of the movement.</td>
        </tr>
        <tr>
            <th>Repeat speed</th>
